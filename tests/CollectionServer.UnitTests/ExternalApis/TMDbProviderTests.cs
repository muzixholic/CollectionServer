...
public class TMDbProviderTests
{
    ...
    private readonly Mock<ILogger<TMDbProvider>> _loggerMock;
    private readonly IOptions<ExternalApiSettings> _settings;

    public TMDbProviderTests()
    {
        _httpClientFactoryMock = new Mock<IHttpClientFactory>();
        _loggerMock = new Mock<ILogger<TMDbProvider>>();
    ...
    {
        var provider = new TMDbProvider(_httpClientFactoryMock.Object, _settings, _loggerMock.Object);
    ...
    [Fact]
    public void ProviderName_ShouldReturnTMDb()
    {
        var provider = new TMDbProvider(_httpClientFactoryMock.Object, _settings, _loggerMock.Object);
        provider.ProviderName.Should().Be("TMDb");
    }
